      ...
      <main id="main-content">
        ...
        <div className="grid gap-3 sm:grid-cols-2 sm:gap-4 print:grid-cols-2">
          {spaces.map((space) => (
            <button
              ...
              disabled={!baseUrl}
              className="card-interactive group w-full p-4 text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 disabled:cursor-wait sm:p-5 print:break-inside-avoid"
        ...
        {selectedSpace && selectedUrl && (
          ...
          >
            ...
            />
            <div
              className="card-panel relative w-full max-w-sm p-4 shadow-2xl sm:p-5"
              role="dialog"
              aria-modal="true"
        ...
        <button
          ...
          className="btn-primary mt-6 sm:max-w-xs print:hidden"
        >
